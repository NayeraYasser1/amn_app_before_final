...
class LanguageCountryScreen extends StatefulWidget {
  ...
  @override
  State<LanguageCountryScreen> get createState => _LanguageCountryScreenState();
}
  ...
  void _saveAndClose() async {
    try {
      await UsageLogger.logAction(
        'language_country_changed',
        data: {'language': _language, 'country': _country},
      );
    } catch (_) {
              ...
              children: [
                ...
                Expanded(
                  child: ElevatedButton(
                    ...
                    child: Text(
                      AppLocalizations.of(context).translate('save_apply'),
                    ),
                  ),
                ),
              ],
